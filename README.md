...
- Go to the repository folder using command prompt cd `Enumerable-Ruby`
...
- On the terminal run this command git clone https://github.com/SabaAhmad404/Enumerable-Ruby.git
...
Feel free to check the [issues page](https://github.com/SabaAhmad404/Enumerable-Ruby/issues).
